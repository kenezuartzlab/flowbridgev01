...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "WEB3 COMMUNITY TOOLS PROJECT SUPPORTING OPEN LEARNING & GROWTH." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "FlowBridge Community Helper Tools" },
      { property: "og:description", content: "WEB3 COMMUNITY TOOLS PROJECT SUPPORTING OPEN LEARNING & GROWTH." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "FlowBridge Community Helper Tools" },
      { name: "twitter:description", content: "WEB3 COMMUNITY TOOLS PROJECT SUPPORTING OPEN LEARNING & GROWTH." },
