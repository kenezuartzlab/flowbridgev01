/**
 * BOT Testnet native rehearsal for MultiSend V1.
 *
...
const artifact = JSON.parse(readFileSync(join(REPO, (process.env["MULTISEND_ARTIFACT"] ?? "contracts/production/multisend-v1/artifacts/FlowBridgeMultiSend.json")), "utf8"));
...
const report = {
  gate: "MULTISEND_V1_BOT_TESTNET_NATIVE_REHEARSAL",
  verdict: "PASS",
  chainId: 968,
  contract: address,
...
const outputPath = join(REPO, "contracts/production/multisend-v1/release/bot-testnet-rehearsal-native.json");
