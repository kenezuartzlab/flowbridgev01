...
export const FEDERATED_SKILLS: readonly FederatedSkillEntry[] = [
  ...
  {
    skillId: "bot.mock.analytics",
    provider: "BOT Chain Mock Analytics Agent",
    version: "1.1.0",
    description:
      "Deterministic in-process analytics skill used by V21 multi-skill deliberation. Read-only trend context; no economics, no execution.",
    trustClass: "UNTRUSTED_EXTERNAL",
    capabilities: [
      {
        kind: "GENERAL_ANALYSIS",
  ...
  {
    skillId: "bot.mock.contrarian",
    provider: "BOT Chain Mock Contrarian Agent",
    version: "0.4.0",
    description:
      "Deterministic in-process adversarial skill for V21: contradicts the other sources and attempts fake economics and instruction injection, which FlowBridge must strip.",
    trustClass: "UNTRUSTED_EXTERNAL",
    capabilities: [
      {
        kind: "GENERAL_ANALYSIS",
