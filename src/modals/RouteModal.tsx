      ...
      >
        ...
        <div className="bg-[#010C1B] border border-white/5 rounded-2xl p-6 flex items-center justify-between relative overflow-hidden font-mono">
          ...
          <div className="flex flex-col items-center gap-1.5 z-10">
            ...
            <span className="text-[10px] font-black tracking-tight text-[#32FF8B]">100%</span>
            <span className="text-[9px] font-bold text-[#C5C1B9] uppercase tracking-wider">{fromSymbol}</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1.5 z-10">
            ...
            <span className="px-2 py-0.5 bg-[#32FF8B]/10 border border-[#32FF8B]/20 rounded-md text-[9px] font-black text-[#32FF8B] mt-1.5 uppercase shadow-inner tracking-wider">
              {isCaryPactDirect ? "V2 0.30%" : `V3 ${poolFee}`}
            </span>
            <span className="text-[8px] font-bold text-white/40 uppercase tracking-widest mt-0.5">Router</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1.5 z-10">
            <TokenIcon symbol={toSymbol} size={36} className="hover:scale-105 transition-transform" />
            <span className="text-[10px] font-black tracking-tight text-[#32FF8B]">100%</span>
            <span className="text-[9px] font-bold text-[#C5C1B9] uppercase tracking-wider">{toSymbol}</span>
          </div>
        </div>

        {/* Informative description */}
        <div className="space-y-3 px-1 text-xs text-[#C5C1B9] leading-relaxed">
          <p>
          ...
          <div className="p-3 bg-[#010C1B]/60 rounded-xl border border-white/5 flex items-center gap-2">
            ...
            <span className="text-[10px] font-semibold text-white/80 font-mono uppercase tracking-wide">
              {isCaryPactDirect 
        ...
        <button
          onClick={onClose}
          className="w-full py-3 rounded-xl bg-[#32FF8B] hover:bg-[#1FFF7D] text-[#010C1B] font-mono tracking-widest font-black text-xs uppercase transition-all duration-150 active:scale-95 cursor-pointer shadow-[0_0_12px_rgba(50,255,139,0.2)]"
        >
          Confirm Route
        </button>
      </div>
