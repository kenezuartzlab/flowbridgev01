  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#010C1B]/95 backdrop-blur-md animate-fade-in font-sans">
      <div 
        ...
        className="bg-[#0D1C2A] border border-white/10 text-[#F0F7F3] rounded-[24px] w-full max-w-[360px] p-6 shadow-2xl relative flex flex-col items-center justify-center space-y-5 text-center animate-scale-up border-b-[5px] border-b-[#32FF8B]"
      >
        {/* Close Button */}
        <button 
          onClick={onClose}
