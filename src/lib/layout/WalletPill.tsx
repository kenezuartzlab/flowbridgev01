...
export function WalletPill({ address, onConnect, onDisconnect }: WalletPillProps) {
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "bg-[#32FF8B] hover:bg-[#1FFF7D] text-[#010C1B] text-sm font-black shadow-[0_0_12px_rgba(50,255,139,0.25)] hover:shadow-[0_0_16px_rgba(50,255,139,0.4)] cursor-pointer"
        )}
      >
  ...
  return (
    <div className="bg-[#0D1C2A]/80 border border-white/10 rounded-xl px-2.5 py-1.5 flex items-center gap-2 shadow-inner font-mono">
      ...
      <span className="text-sm font-extrabold text-[#F0F7F3]">{shortened}</span>
      <button
