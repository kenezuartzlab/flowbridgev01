/**
 * Live pause / unpause acceptance for MultiSend V1 on BNB Testnet (chain 97).
 *
...
const report = {
  gate: "MULTISEND_V1_BNB_TESTNET_LIVE_PAUSE_ACCEPTANCE",
  verdict: "PASS",
  chainId: 97,
  contract: address,
  owner,
...
writeFileSync(
  join(REPO, "contracts/production/multisend-v1/release/bnb-testnet-pause-acceptance.json"),
